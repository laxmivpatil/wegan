...
public class OrderController {
	...
	/*
	 * @GetMapping("/invoice") public ResponseEntity<String> getInvoice() { String
	 * result = InvoiceService.createInvoice(); return new ResponseEntity<>(result,
	 * HttpStatus.OK); }
	 */
	@PostMapping("/addshippingaddress")
	public ResponseEntity<Map<String, Object>> addShippingAddress(@RequestBody ShippingAddress shippingAddress,
			@RequestHeader("Authorization") String jwt) throws UserException {
		// Retrieve the user by ID (you may adjust this based on your authentication
		// mechanism)
	...
	public ResponseEntity<Map<String, Object>> setShippingAddress(@RequestParam Long addressId,
			@RequestHeader("Authorization") String jwt) throws UserException {
		// Retrieve the user by ID (you may adjust this based on your authentication
		// mechanism)
		User user = userService.findUserProfileByJwt(jwt);
	...
	public ResponseEntity<Map<String, Object>> getShippingAddressesByUser(@RequestHeader("Authorization") String jwt)
	...
	public ResponseEntity<Map<String, Object>> getDefaultShippingAddressesByUser(
			@RequestHeader("Authorization") String jwt) throws UserException {
		User user = userService.findUserProfileByJwt(jwt);
		...
		List<ShippingAddress> shippingAddresses = user.getShippingAddresses().stream()
				.filter(ShippingAddress::isSetDefaultAddress).collect(Collectors.toList());
	...
	public ResponseEntity<Map<String, Object>> editShippingAddress(@PathVariable("addressId") Long addressId,
			@RequestBody ShippingAddress updatedAddress, @RequestHeader("Authorization") String jwt)
			throws UserException {
		User user = userService.findUserProfileByJwt(jwt);
	...
	public ResponseEntity<Map<String, Object>> deleteShippingAddress(@PathVariable("addressId") Long addressId,
			@RequestHeader("Authorization") String jwt) throws UserException {
		User user = userService.findUserProfileByJwt(jwt);
	...
	public ResponseEntity<Map<String, Object>> getShippingAddressById(@PathVariable("addressId") Long addressId,
	...
	public ResponseEntity<Map<String, Object>> verifyPayment(@RequestHeader("Authorization") String jwt,
			@PathVariable("Id") String paymentId, @PathVariable("orderId") String orderId)
	...
	public ResponseEntity<String> verifyAndTransferPayment(@RequestHeader("Authorization") String jwt,
			@PathVariable("Id") String paymentId) throws Exception {
		// Verify payment
		Payment payment = razorpayService.verifyPayment(paymentId);
	...
	@GetMapping("/user")
	public ResponseEntity<Map<String, Object>> userOrderHistory(@RequestHeader("Authorization") String jwt)
			throws UserException {
	...
	public ResponseEntity<Map<String, Object>> getOrderItemsByBuyer(@RequestHeader("Authorization") String jwt
	...
	public ResponseEntity<Map<String, Object>> getOrderItemsByOrderId(@RequestHeader("Authorization") String jwt,
			@PathVariable("Id") Long orderId) throws UserException, OrderException {
		User user = userService.findUserProfileByJwt(jwt);
	...
	public ResponseEntity<Map<String, Object>> requestcancelOrderItembyBuyer(@RequestParam Long orderItemId,
			@RequestParam(value = "reason", required = false) String reason) {
		OrderItem updatedOrderItem = null;

		updatedOrderItem = orderItemService.requstCancelOrderItemStatusandReason(orderItemId,
